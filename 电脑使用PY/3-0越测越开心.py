...
# 检查存在的文本文件
text_files = ['HK.txt', 'KR.txt', 'SG.txt', 'GFYMIP.txt','GFYMIP-IPv6.txt' ,'TW.txt', 'AE.txt', 'US.txt', 'DE.txt', 'JP.txt', 'CA.txt', 'CH.txt', 'GB.txt', 'IN.txt', 'IT.txt', 'NL.txt', 'BG.txt', 'FR.txt', 'DK.txt', 'PH.txt', 'SE.txt', 'CN.txt', 'ID.txt']
