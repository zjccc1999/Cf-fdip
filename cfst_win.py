...
# -*- coding: utf-8 -*-
"""
Windows Cloudflare 测速脚本 - 最终版（仅IPv4）
...
class CloudflareSpeedTestIStoreOS:
    def __init__(self):
        ...
        print(Fore.CYAN + "=" * 80)
        print(Fore.GREEN + "🚀 Windows Cloudflare 测速脚本 [最终版]")
    ...
    def get_cfst_url(self):
        ...
        print(Fore.CYAN + f"📥 将使用 cfst {v} (Windows amd64)")
        return url, v
